function myFunction() {
    ...
    const getDataModern = async () => {
      ...
      $("tbody").children().remove();
        ...
        const data = await fetch("http://webapi19sa-1.course.tamk.cloud/v1/weather/light/" + time_interval);
    ...
    (async () => {
      ...
      const chartData = dataJson
        ...
        .slice(0, 100)
        .map(item => ({ x: item.date_time, y: item.light }))
        .sort((a, b) => a.x - b.x);
